# Переводим паровые и атомные электростанции в резерв
...
Справа у нас находится некая воображаемая электростанция, показанная иконками на постоянном комбинаторе. Соответственно, слева, вместе с воображаемыми солнечными панелями и аккумуляторными блоками находятся воображаемые потребители электроэнергии (тоже иконки), которые нещадно разряжают аккумуляторные блоки (один в центре). Когда заряд аккумуляторного блока становиться меньше 5 процентов включается выключатель питания, а когда заряд аккумуляторного блока становиться больше 60 процентов, выключается. За это отвечают два сравнивающих комбинатора, к которым подключен аккумуляторный блок. Постоянный комбинатор рядом с выключателем питания нужен для того, чтобы выключатель питания работал постоянно, без учёта чего там вундершняга по напридумывает. Его можно убрать без ущерба для всех.
