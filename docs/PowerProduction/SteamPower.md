...
| 900 `!Coal` | <nobr>100% `!Transport belt`</nobr> | 2 `!Offshore pump` |   34 `!Boiler` | 72 `!Steam engine` | 61.2 | Максимум на одном конвейере угля |
...
| 900 `!Solid fuel` | <nobr>100% `!Transport belt`</nobr> | 5 `!Offshore pump` |   100 `!Boiler` | 200 `!Steam engine` | 180 | Максимум на одном конвейере твёрдого топлива |
...
[*![Организация подачи воды](./images/PowerProduction.07.jpg)*](./images/SteamPower.05.jpg)
