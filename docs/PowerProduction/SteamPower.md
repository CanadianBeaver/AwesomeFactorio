...
Производство электроэнергии из пара, путем сжигания угля, твёрдого топлива или какого-то иного топлива в игре реализовано элементарно, поэтому пишу инструкции для школьников, начитавшихся [разной херни из интернетов](https://habr.com/ru/companies/itsumma/articles/551622/).
:::
...
Предыдущие две электростанции вырабатывают примерно 150 мегаватт электричества, что вполне [хватает для победы в игре](./README.md#начальная-база-на-45-научных-пакетов-в-минуту). Добавив ещё одну электростанцию на полном конвейере твердого топлива, можно [снабжать фабрику на 75 научных пакетов](./README.md#начальная-база-на-75-научных-пакетов-в-минуту):
...
Используйте 34 бойлера для паровой электростанции на угле и 50 бойлеров для электростанции на твёрдом топливе. Двух таких электростанций хватит на всё, чтобы запустить ракету в космос.
