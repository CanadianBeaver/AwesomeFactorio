...
Далее предлагаются к рассмотрению, изучению, углублению, ещё раз смотрению и наконец-то использованию везде где только можно разного рода чертежей, они же `Blueprint`.
