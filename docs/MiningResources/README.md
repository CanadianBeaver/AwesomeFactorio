...
Добыча разной руды, угля и камней основа всего и вся в Factorio. Без ресурсов не построишь даже [твёрдотопливный манипулятор](../HowToStartNewGame/BurnerDevices.md#твёрдотопливные-манипуляторы).
:::

*![Пойдём с нами в забой](./images/index.01.jpg#right50)* Добычу ресурсов можно вести твёрдотопливными бурами `Burner mining drill` или электрическим бурами `Electric mining drill`. Тут капитан очевидность спешит на помощь, других буров в игре как бы не предусмотрено. Разве что киркой `Steel axe` махать собственноручно (*кстати, кирка почему-то называется стальным инструментом, оригинальный перевод, вот бы всем по стальному инструменту*). Добыча твёрдотопливными бурами стоит рассматривать как временный этап на самой ранней стадии игры, который стоит сменить как можно скорее на добычу электрическими бурами. Добыча электрическими бурами ничем не отличается от ресурса к ресурсу. Все чертежи полностью одинаковы что для железной руды `Iron ore`, что для медной `Copper ore`, что для камней `Stone`, что для угля `Coal`. Даже [добыча урановой руды](./UraniumOre.md) `Uranium ore` не сильно отличается, главное чтобы электрические буры были полностью пристыкованы боками друг к другу или соединены трубами `Pipe` для подачи серной кислоты `Sulfuric acid`.
...
А вот следующий чертёж будет хорош на высоких уровнях продуктивности добычи `Mining productivity`. На обычных параметрах карты, можно начинать использовать на уровнях продуктивности 45+ баба ягодка опять или даже чуть раньше. Количество выходных линий хватит на несколько погрузочных вокзалов расположенных на добывающих шахтерских аванпостах.
...
А вот и чудо роботизации. Чертёж не плох, имеет хорошее покрытие, имеет хорошее количество выходных конвейеров. Но при этом, не стыкуется по вертикали, не подходит для добычи урановой руды, безумно дорог из-за подземных конвейеров, не ровно выровнены выходные конвейеры, имеет разное количество буров на стороны конвейера, руками такое чудо строить трудно. Деревянные опоры ЛЭП `Small electric pole`, можно заменить на средние `Medium electric pole`.
...
## Как строить добывающие аванпосты?
...
https://youtube.com/watch?v=ZI2aVerqCT4
