...
Добыча урановой руды `Uranium ore` самое простое, что с чем можно столкнуться в *Factorio*.
:::
