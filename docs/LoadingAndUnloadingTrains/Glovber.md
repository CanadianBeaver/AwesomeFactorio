...
Станции погрузки для поездов с разношерстной перевозкой предметов стоит размещать поближе к производимому хабару, но провернуть такое получается далеко не всегда, ведь нужные предметы придётся доставлять роботами с разбросанных по фабрике производств. В самом начале строительства большой фабрики, то есть [после запуска первого спутника](../HowToStartNewGame/AfterSatelliteLaunch.md), логично держать станцию погрузку ближе к фабрикам снабжения, яки моллам, но по мере роста фабрики и увеличения количества форпостов один единственный молл может перестать справляться с нагрузками. Моллы, как маленькие фабрики, лениво создают весь возможный хабар понемногу, удовлетворяя лишь базовые нужды инженера, а строить второй аналогичный молл бессмысленно, ведь вам не нужно производить весь огромный ассортимент предметов в два раза больше. Для бесперебойного снабжения удаленных форпостов потребна узкая специализация на конкретных предметах, таких как постоянно расходуемая на линии фронта амуниция, ремонтные комплекты, топливо и прочее.

Поэтому станцию погрузки для снабжения гораздо разумнее размещать поблизости к отдельному выделенному блоку производства, заточенному исключительно под нужды форпостов, для чего отлично подходят масштабируемые сити-блоки. Если в обозримом будущем вам понадобится серьезно расширить это направление, вы просто переносите один из соседних сити-блоков в другое место и строите на освободившемся месте дополнительный завод для закрытия потребностей снабжения форпостов.
