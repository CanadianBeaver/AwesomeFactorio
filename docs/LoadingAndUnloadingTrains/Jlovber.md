...
## Контролируемая погрузка одним манипулятором
...
## Погрузка разношёрстных предметов
