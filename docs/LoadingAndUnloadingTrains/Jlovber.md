...
Такой вариант использования действительно существует, и в сообществе игроков он называется строительным поездом в один конец. Это невероятно удобный способ расширения фабрики, который позволяет за считанные минуты развернуть полностью автономный укреп-район прямо под носом у кусак.
