...
:::tip Вся статья, кратко *![Капитан Ачевидность](../RawResourcesProcessing/images/CaptainObvious.jpeg#right)*
...
## Про модули, синие, зелёные и ещё непонятного цвета

Отдельно есть желание рассказать про модули, так как тема сия не простая в *Factorio*. На самом деле, нужно выделять не сами типы модулей, хотя понимать типы модулей и их применимость тоже нужно. Важнее выделять направление развития игры и соответсвующее применение модулей для строительства производящей базы. И тут существует два направления (смотри выше про капитана очевидность), отличающиеся своими игровыми механиками и опытом:

:::tip Зелёная энергетика и экологическое развитие

Тут всё [по заветам Гретты](https://en.wikipedia.org/wiki/Pristimantis_gretathunbergae) с напором на модули эффективности `!Efficiency module 3`
:::

:::warning Мне плевать на всю местную фауну, гажу как хочу

Тут с напором на связку модулей производительности и скорости `!Productivity module 3` + `!Speed module 3`.

:::

А теперь немного теоретической нудятины, которую должны знать все, без исключения.

### Модули продуктивности

Самые интересные модули, `!Productivity module` `!Productivity module 2` `!Productivity module 3`. Добавляют *фиолетовую полосу продуктивности* в постройках и позволяют производить дополнительные предметы. Каждый раз, когда производственное строение завершает цикл производства, *полоса продуктивности* увеличивается на процент, равный эффекту установленных модулей продуктивности. При достижении 100% полосы происходит генерация ещё одного предмета без потребления ресурсов. А ещё, эти модули уменьшают скорость производства и увеличивают загрязнение. В общем, модули продуктивности действуют подобно исследованию продуктивности добычи, но на постройки, в которые вставлены.
