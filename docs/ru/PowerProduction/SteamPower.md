...
Одним конвейером (`Transport belt`) угля можно питать 34 бойлера (`Boiler`), которые дают пар для 68 паровых двигателей (`Steam engine`) что позволяет вырабатывать 61.2 мегаватт энергии.
:::
...
Не используйте ракетное топливо для производства паровой энергии, оно не эффективно, [пруф](EfficientFuelForSteamPower.md#твердое-топливо-супротив-ракетного), [исчё пруф](https://www.youtube.com/watch?v=avZhWqnDwHI&t=224s).
:::
