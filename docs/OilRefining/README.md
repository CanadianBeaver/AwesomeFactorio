...
Если играть без местной фауны и без загрязнения, то модули в начале игры не нужны, если только электричества хватает. А после запуска спутника извращайтесь как хотите, но эффективней будет один модуль скорости и два модуля продуктивности `!Speed module 3` `!Productivity module 3` `!Productivity module 3`.
...
| > | > | После запуска спутника, без фауны и загрязнения |
...
| <nobr>`!Speed module 3` `!Productivity module 3` `!Productivity module 3`</nobr> | *даёт экономию энергии на единицу производимого продукта* |  20% сохранения ресурсов за счёт 230% потребления энергии плюс скорость производства в два раза выше чем предыдущий случай, а значить потребуется в два раза меньше заводов |

## Большая база

Большая база это множество маленьких производств. Не пытайтесь строить нефтеперерабатывающий завод производящий всё, как на начальной базе. Тут лучше воспользоваться принципом "*одно нечто делает только одно шота*". Исключение составит смазочная жидкость `Lubricant`, которую придётся комбинировать с производством попутного газа или ракетного топлива. Производить отдельно твёрдое топливо не нужно. То есть, строим множество мелких нефтеперерабатывающих заводов по следующим правилам:
