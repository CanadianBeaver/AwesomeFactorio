...
Огнемётные турели весьма опциональны, но крайне эффективны против местной фауны. Несмотря на высокий урон, их эффективность раскрывается только против массовых групп. Одной установки достаточно для создания заградительного огня. Основной сложностью остается логистика топлива, требующая защищенных трубопроводов. Используйте их как дополнение к лазерам для экономии энергии и боеприпасов.
...
*![Направление атаки стенами на мины](./images/MilitaryOutposts.Walls.webp)*
...
### Производство артиллерийских снарядов на месте или доставка с фабрики (УКАЗАТЬ РЕЦЕПТ ДЛЯ ПРОИЗВОДСТВА)
...
## Примеры эффективных фортификаций (TBD)
...
## Частые ошибки при постройке (TBD)
