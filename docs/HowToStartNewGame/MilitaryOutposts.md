...
Настройка турелей чистая религия, доказательств нет, зато за неправильное мнение могут наслать порчу в интернетах. В моём храме автоматизации догматы просты. Огнемётные турели мы настраиваем как элитного вышибалу. Они разбрасывают горящее топливо только на крупные цели, которые реально могут покусаться или поплеваться. Пулеметные турели работают по схожей схеме, но мягче, выставляем им приоритет на жирные мишени, чтобы дорогая аммуниция не тратилась на мелочь ценой в киловатт для лазерного выстрела. А вот лазерным турелям мы отдаем грязную работу. Пусть выщелкивают всё подряд с приоритетом на назойливых плевак доставляющих неудобство на расстоянии.

:::info Применяйте на свой страх и риск
...
*![Рецепт производства артиллерийского снаряда на форпосте](./images/MilitaryOutposts.ArtilleryShell.webp)*
...
### Малюсенькие фортеции в единой логистической сети
...
И первым делом **расставляем огонёк**, то есть оптимально располагаем огнемётные турели. Ставим в центр чертежа подстанцию `!Substation`, которая занимает 2*x*2 клеток, а впритык к подстанции расстанавливаем три огнемётные турели `!Flamethrower turret`, направленные в разные стороны, кроме стороны нашей фабрики. Со стороны фабрики рядом с огнемётными турелями и подстанцией удобно расположить радар и сборочный автомат, который питает топливом `!Light oil` огнемётные турели. Ещё по бокам удобно вставить пулемётные турели `!Gun turret`, а ниже артиллерийское `!Artillery` орудие и дрынстанцию `!Roboport`. Организуем доставку амуниции и запчастей в сундук запроса `!Requester chest` и буферный сундук `!Buffer chest`. Всё компактно.

Следующий шагом **добавляем лазерку**, располагаем лазерные турели вокруг наших построек в одну линию. На передок можно добавить парочку дополнительных турелей, не помешают, как раз по бокам имеется хорошее место.

Опционально **добавляем стены**, которые располагаем так дабы они типа создавали узкие проходы, хотя и сомнительно, но не усердствуем. И всё, форпост готов жечь жуков, ослеплять лазером и валить бронебойными патронами. Мощная точка которая борется с экспансией и защищает себя от возмездия.

Альтернативный вариант **без огонька**, ежели не хотите связываться с логистикой пустых бочек и переливанием топлива. Тут усиление пулемётными турелями и лазерными, заметно огнемётных.

Ещё большего профита **с усилением** можно добиться если расположить огнемётные турели по другому, добавить больше пулемётных и лазерных турелей, хотя по мне, так излишне, но случаи разные бывают.

Но самое привлекательное свойство этих трёх форпостов заключается в том, что **няшечка** легко вписывается в минимальный железнодорожный круг, а значить перекрёстки типа *RoundAbout* становятся ещё и форпостами. Напомню, такой круговой перекресток основа построения всяких ваших *сити-блоков*.

<Tabs>
  <TabItem value="step1" label="Расставляем огонёк">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.01.webp)*
  </TabItem>
  <TabItem value="step2" label="Добавляем лазерку">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.02.webp)*
  </TabItem>
  <TabItem value="step3" label="Добавляем стены">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.03.webp)*
  </TabItem>
  <TabItem value="step4" label="Без огонька">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.04.webp)*
  </TabItem>
  <TabItem value="step5" label="С усилением">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.05.webp)*
  </TabItem>
  <TabItem value="step6" label="Няшечка">
  *![Примерная схема расположения турелей](./images/MilitaryOutposts.Example.01.06.webp)*
  </TabItem>
</Tabs>

Чертежи всех фортификаций будут в конце статьи.

### А теперь фортеций с доставкой поездами
