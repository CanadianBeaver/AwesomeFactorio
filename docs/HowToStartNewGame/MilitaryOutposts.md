...
<Tabs>
  ...
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.01.webp)*
  </TabItem>
  <TabItem value="step2" label="Добавляем лазерку">
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.02.webp)*
  </TabItem>
  <TabItem value="step3" label="Добавляем стены">
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.03.webp)*
  </TabItem>
  <TabItem value="step4" label="Без огонька">
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.04.webp)*
  </TabItem>
  <TabItem value="step5" label="С усилением">
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.05.webp)*
  </TabItem>
  <TabItem value="step6" label="Няшечка">
  *![Примерная схема расположения турелей в Factorio](./images/MilitaryOutposts.Example.01.06.webp)*
  </TabItem>
</Tabs>
