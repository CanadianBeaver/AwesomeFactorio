...
*![Загрузка патронов в пулемётные турели](./images/CombatTactics.15.webp)*
...
3. **Занимаемся ульями**. Когда остались только улья `!Biter spawner` `!Spitter spawner`, выставляем новые пулемётные турели по близости к ним и защищаем турели от всего что шевелится.
