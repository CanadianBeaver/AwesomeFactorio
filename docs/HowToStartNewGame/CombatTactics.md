...
Можно ещё усилить, если прикуплен платный *SA* мод, но смысла особого нет.

*![Экипировка для паукотрона в Factorio](./images/CombatTactics.11.webp)*

Для планеты `Gleba` придётся по другому.




TBD:рассказать как группировать паукторонов в пролом и настоящем
