...
Особой полезности *панель ярлыков* не представляет, так как все кнопки связанные с игровыми функциями можно вызвать и с клавиатуры даже если эта панель полностью скрыта.
