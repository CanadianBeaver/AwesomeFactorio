...
Освоить основы игры *Factorio* и избежать типичных ошибок вполне реально, если вооружиться проверенными советами. А я плохого не посоветую, это точно. Или не точно? Предлагаю внимательно почитать чего этакого я научился и там решить, точно или не точно. Итак, всё списку.
...
Строго говоря в *Factorio* различается *Quickbar* как панель быстрого доступа и *Shortcut bar* как панель ярлыков. Но их суть мало чем отличается. В обоих случаях фокус в нажатии кнопок связанных игровыми предметами или игровыми функциями. Настройка и работа панелей детально [описана тут](./Quickbar.md), учитесь пользоваться, инструмент полезный.

*![Quickbar and Shortcut bar in Factorio](./images/Quickbar.03.jpg)*
...
Клавиша ***E*** используется для открытия инвентаря, он же рюкзак. Это одна из самых часто используемых клавиш, поскольку позволяет быстро управлять ресурсами, предметами и экипировкой, а также производить предметы в ручную из запасов в рюкзаке.

*![настройки пипетки](./images/TipsAndTricks.E.Settings.jpg)*

Кроме того, клавиша ***E*** также служит для закрытия любых открытых окон интерфейса. Если у вас открыт инвентарь, рюкзак который, или какой-нибудь другой игровой интерфейс, нажатие ***E*** закроет его.
...
## Другие горячие хотдоги

---

<font color="red">Рассказать про другие клавиши</font>
