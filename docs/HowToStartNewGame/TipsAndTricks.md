...
Строго говоря в *Factorio* различается *Quickbar* как панель быстрого доступа и *Shortcut bar* как панель ярлыков. Но их суть мало чем отличается, начатие кнопок связанных игровыми предметами или функциями. Настройка и работа панелей [описана тут](./Quickbar.md), пользуйтесь, инструмент полезный.
