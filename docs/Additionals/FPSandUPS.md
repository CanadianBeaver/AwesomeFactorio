...
|:-:|:--|:--|
|S|AMD Ryzen 7 9800X3D|Абсолютный лидер по FPS и UPS|
...
|A|Intel Core i7-14700KF|Высокая частота и отличная однопоточная производительность, но уступает 3D|
|B|AMD Ryzen 7 9700X|Хорошая производительность, но без 3D|
|B|Intel Core i5-14600K|Хорошее соотношение цена/производительность, но уступает топам|
|C|AMD Ryzen 5 7600X|Достаточно для средних баз, но не для мегабаз|
|C|Intel Core i5-12400|Бюджетный вариант для небольших фабрик|
