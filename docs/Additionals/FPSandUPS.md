...
На самом деле, экономичного `i5-7500T` вполне достаточно, чтобы отправить рыбку в космос и [завершить игру](../PowerProduction/README.md#этап-первый-или-космический-спутник-своими-руками). Сиё проверено на *Dell OptiPlex 3050M*. Старенький процессор вместе со своей встройкой вполне вытягивают 60UPS на *Full HD*. Этого вполне достаточно, чтобы поиграться до запуска первого спутника. Однако большую производственную фабрику на тысщи научных пакетов в минуту такое устройство уже не потянет.
...
|:-:|:--|:--|
|S|AMD Ryzen 7 9800X3D|Абсолютный лидер по UPS|
...
|A|Intel Core i7-14700KF|Высокая частота и отличная однопоточная производительность, но уступает X3D|
