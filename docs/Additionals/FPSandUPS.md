...
Играя в *Factroio* основная нагрузка ложится полностью на процессор, который *CPU*, он же *штэуд* али *амудэ*. Видеокарта мало как влияет на расчёты игрового мира. Большинство вычислений выполняется в одном потоке, хотя на дворе уже век Ай-Яй и восьми ядер. Поэтому производительность напрямую зависит от мощности одного ядра процессора. Также особое влияние играет скорость оперативной памяти, но это только если скорости процессора достаточно. Прям как у матанализе.

:::info Какая нужна видеокарта, невидиа, амадэ али ынтыл?
Для игры в *Factorio* видеокарта не нужна, хватит и любой встройки...
:::

На самом деле, экономичного `i5-7500T` вполне достаточно, чтобы отправить рыбку в космос и [завершить игру](../PowerProduction/README.md#этап-первый-или-космический-спутник-своими-руками). Сиё проверено на *Dell OptiPlex 3050M*. Старенький процессор вместе со своей встройкой вполне вытягивают 60UPS на *Full HD* и этого достаточно дабы поиграться в запуск первого спутника. Однако большую производственную фабрику на многие тыщи научных пакетов в минуту такое устройство уже не потянет.

:::info На что ориентируемся?
Нужны мощные штэуды с большим бустом на одно ядро и быстрой памятью. Или амудэшные с 3D кэшем, они переплюнут всё, именно из-за быстрого и большого кэша.
:::

|Ранг|Модель процессора|Особенности для Factorio|
|:-:|:--|:--|
|S|AMD Ryzen 7 9800X3D|Абсолютный лидер по UPS, но нужна дискретная видеокарта и много шекелей|
|S|AMD Ryzen 7 7800X3D|Чуть уступает 9800X3D, но всё ещё топ|
|A|AMD Ryzen 9 7950X3D|Не всегда эффективнее 7800X3D из-за специфики нагрузки|
|A|Intel Core i7-14700K|Высокая частота и отличная однопоточная производительность, но уступает X3D|
|B|AMD Ryzen 7 9700X|Хорошая производительность, но без X3D не вытягивает|
|B|Intel Core i5-14600K|Хорошее соотношение цена/производительность, но уступает топам|
|C|AMD Ryzen 5 7600X|Достаточно для средних фабрик, но не для больших|
|C|Intel Core i5-12400|Бюджетный вариант для небольших и средних фабрик|
|Z|всё что хуже|Вариант чтобы добраться до разрушенной планеты и вернуться назад|
...
А вообще, все проблемы с производительностью можно будет решить лет через двадцать, когда компьютеры, согласно закону Мура, смогут тянуть *Factorio*. И то не факт, зато есть время подготовиться и обзавестись хорошими чертежами. Сколько вам там сейчас, за сорок уже небось? Ну так при выходе на пенсию будет вам счастье. Или нет, согласно этому графику:

*![cpu-performance.webp](./images/cpu-performance.webp)*
...
*![Factorio на 5 UPS](./images/FPSandUPS.01.webp)*
