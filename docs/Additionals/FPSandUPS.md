...
Играя в *Factroio* основная нагрузка ложится полностью на процессор, который *CPU*, он же *штэуд* али *амудэ*. Видеокарта мало как влияет на расчёты игрового мира. Большинство вычислений выполняется в одном потоке, хотя на дворе уже век Ай-Ай и восьми ядер. Поэтому производительность напрямую зависит от мощности одного ядра процессора. Также особое влияние играет скорость оперативной памяти, но это только если скорости процессора достаточно. Прям как у матанализе.
