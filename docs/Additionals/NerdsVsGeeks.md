...
Может показаться, что выход платного DLC, который стоит как сама игра, очень сильно изменил ситуацию. Но нет, головокружение от успеха платного DLC прошло ещё быстрее, чем головокружение от релиза самой игры. Вот вам пруф, количество играющий игроков не изменилось:

[*![Новое количество игроков Factorio](./NerdsVsGeeks.03.png)*](https://steamdb.info/app/427520/charts/)

Конечно, платное DLC вызвало большой интерес у сообщества, но также быстро этот интерес пропал, новых личностей прибавилось мало, всего тыщу.
