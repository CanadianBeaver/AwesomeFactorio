...
Создавать логические сети без комбинаторов весело и прикольно, одним сигнальным проводом соединяем два элемента игры и радуемся счастью. Первый подсоединившийся отсылает в сеть своё состояние, режим чтения. Второй присоединившийся как-то реагирует на полученное состояние, режим действия. Профффит.
