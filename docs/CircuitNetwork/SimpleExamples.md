...
Схема позволяет сохранять заданные количества жидкостей в резервуарах и не допускать перерасходование [при переработке нефти](../OilProcessing/README.md#строим-нефтеперерабатывающий-завод), особенно относится к дизельному топливу `Light oil`.
