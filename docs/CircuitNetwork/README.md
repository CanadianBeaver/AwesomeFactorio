...
Нет ничего проще, чем соединить между собой две игровые сущности в *Factorio* посредством сигнального кабеля, `Green wire` или `Red wire`. Вот пошаговый алгоритм создания такой сети:
