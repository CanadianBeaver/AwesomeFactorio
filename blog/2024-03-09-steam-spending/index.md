...
Напомню, что есть разница между паром из бойлера при температуре 165 градусов и из теплообменника температурой аж 500. Пар можно расходовать двумя способами: *сжижать уголь* и *добывать электричество*.
